...
def get_addr(otherversion=0):
    # random compressed
    key_pair = create_addr(gen_eckey(compressed=True,version=otherversion),version=otherversion)
    return key_pair
...
if __name__ == '__main__':
    ...
    Bitcoin Testnet = 111
    Dogecoin Mainnet = 30
    Dogecoin Testnet = 113'''
    (options, args) = parser.parse_args()
    print 'Version = %s' % options.otherversion 
    get_addr(int(options.otherversion))
